const color = {
  ...
  hardIron: "#414242",
  hardLighterIron: "#f1f2f4",
  scienceBlue: "#0366D6",
  hardLighterScienceBlue: "#cde0f7",
  hardScienceBlue: "#1a4c84",
...
export const dark = {
  ...
  tile: {
    ...
    borderAlternative: color.hardIron,
    hover: color.semiTransparentDarkerScienceBlue,
    hoverAlternative: color.hardScienceBlue,
  },
  button: {
    text: color.white,
...
export const light = {
  ...
  tile: {
    ...
    border: color.semiTransparentIron,
    borderAlternative: color.hardLighterIron,
    hover: color.semiTransparentScienceBlue,
    hoverAlternative: color.hardLighterScienceBlue,
  },
  button: {
    text: color.white,
